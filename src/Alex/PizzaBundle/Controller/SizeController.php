...
use Alex\PizzaBundle\Form\SizeType;
...
class SizeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AlexPizzaBundle:Size')->findAll();

        return $this->render('AlexPizzaBundle:Size:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AlexPizzaBundle:Size:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AlexPizzaBundle:Size')->find($id);
        ...
        return $this->render('AlexPizzaBundle:Size:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AlexPizzaBundle:Size:edit.html.twig', array(
            'entity'      => $entity,
