...
class KostenController extends Controller {
    ...
    public function createAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('kosten_show', array('id' => $entity->getId())));
        }
    ...
    public function showAction($id) {
        ...
        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Kosten entity.');
        }
    ...
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('kosten_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id) {
        ...
        return $this->redirect($this->generateUrl('kosten'));
    }

    /**
     * Creates a form to delete a Kosten entity by id.
     *
